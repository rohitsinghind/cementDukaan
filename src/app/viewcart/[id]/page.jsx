...
export default function ViewCart({params}) {
            ...
            <div className="bg-white border border-gray-200 rounded-lg px-4 py-6">
              ...
              <div className="border-b border-gray-200 p-2">
                <div className="flex justify-between py-2">
                  ...
                  <span>₹{(product?.originalPrice*qty).toLocaleString("en-IN")}</span>
                </div>
                <div className="flex justify-between py-2">
                  <span>Discount</span>
                  <span className="text-green-600">- ₹{((product?.originalPrice - product?.price)*qty).toLocaleString("en-IN")}</span>
                </div>
                <div className="flex justify-between py-2">
                  <span>Delivery Charges</span>
                  <span>
                    <span className="line-through text-gray-500">₹{product?.delivery.toLocaleString("en-IN")}</span>
              ...
              <div className="text-lg font-semibold text-gray-900 border-b border-gray-200 p-2 flex justify-between">
                <span>Total Amount</span> <span>₹{(product?.price * qty).toLocaleString("en-IN")}</span>
              </div>
              <div className="text-green-600 font-semibold p-2">
                You will save ₹{((product?.originalPrice - product?.price)*qty + product?.delivery).toLocaleString("en-IN")} on this order
              </div>
            </div>
