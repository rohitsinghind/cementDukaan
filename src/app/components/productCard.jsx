...
export default function ProductCard({
  ...
  return (
    <>
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow cursor-pointer">
      <Link href={`/product/${productId}`}>
        <img
          className="rounded-t-lg sm:p-5 p-2.5"
          src={thumbnailImg}
          alt="product image"
        />
        <div className="sm:px-5 px-3 pb-5">
            <h5 className="sm:text-sm text-sx font-semibold tracking-tight text-stone-800">
              {title}
            </h5>
          ...
          <button
            type="button"
            className="text-white bg-orange-600 hover:bg-orange-500 font-medium rounded-3xl sm:text-sm text-xs px-5 py-2.5 text-center inline-flex items-center mt-2.5 w-full flex justify-center items-center gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
