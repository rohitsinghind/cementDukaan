...
export default function AddAddressDialog({open, setOpen}) {
    ...
    const [address, setAddress] = useState({name:"",phoneNo:"",pincode:"",address:"",area:"",city:"Jamshedpur/Jharkhand"})
    ...
    <div className={`bg-[#000000af] overflow-hidden backdrop-blur-md w-full h-screen fixed top-0 ${open?"":"hidden"}`}>
        <div class="fixed z-10 my-auto mx-auto inset-x-0 inset-y-0 w-96 h-fit max-h-screen my-4 overflow-y-scroll bg-white rounded-lg shadow">
            ...
            <div class="p-6">
                ...
                <h3 className="font-semibold text-sm text-gray-600 text-center mb-3">Add new Address</h3>
                <div class="">
        <div>
