    ...
    products: [
      {
        ...
        qty: 1,
        timeline:[
            { title: "Ordered Confirmed", desc: "Sun, 11th Feb 2023", color: "green" },
      ...
      <div className="max-w-screen-xl sm:px-4 px-2 py-6 mx-auto my-4 rounded">
        {
            orders?.map((order)=>{
                return(
                    <>
                    <h1 className="font-semibold text-gray-600 text-lg my-2 text-center mt-4">Ordered on {order?.createdAt}</h1>
          ...
          return (
            <li class="mb-10 ms-6">
              ...
              >
                ...
                :
            <svg class={`w-3.5 h-3.5 text-${item?.color}-500`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
            </svg> 
        }
              </span>
              <h3 class="font-medium leading-tight sm:text-lg text-sm">{item?.title}</h3>
              <p class="sm:text-sm text-xs">{item?.desc}</p>
            </li>
          );
        })}
      </ol>
